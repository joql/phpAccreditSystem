 ...
 ?>
 									<?php 
										...
										if($result&&mysql_num_rows($result)){
											...
											echo "<td >".$row['file']."</td>";
											echo "<td >".base64_decode($row['datae'])."</td>";
											echo "<td >
												<a class='btn btn-primary btn-xs' href='version-chanage.php?id=".$row['id']."'><i class='fa fa-edit'></i></a>   <a class='btn btn-primary btn-xs' href='javascript:if(confirm(\"你确实要删除此条版本信息吗?\"))location=\"./version-del.php?id=".$row['id']."\"'><i class='fa fa-ban'></i></a>  <a class='btn btn-primary btn-xs' title='生成文件列表' href='version-pr.php?c=do&id=".$row['id']."&file=".$row['file']."'><i class='fa fa-copy'></i></a>
											</td>";
											echo "</tr>";
											}
										}
