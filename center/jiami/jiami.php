...
// 调试模式: 0:关闭; 1:调试模式; 参数开启调试, URL中带上：jiami_debug
// 线上请务必将此参数修改复杂不可猜出
define('DEBUG', ((isset($argc) && $argc) || strstr($_SERVER['REQUEST_URI'], 'jiami_debug')) ? 1:0);
// 站点根目录
define('ROOT_PATH', dirname(__FILE__).'/');
// 框架的物理路径
define('FRAMEWORK_PATH', ROOT_PATH.'weby/');
...
// 包含核心框架文件，转交给框架进行处理。
include FRAMEWORK_PATH.'weby.php';
